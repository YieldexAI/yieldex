...
class PoolFactory:
    ...
    @staticmethod
    def create_minimal_pool(symbol='USDC', chain='Ethereum', project='aave-v3', apy=5.0, tvl=1000000):
    ...
    @staticmethod
    def create_full_pool(symbol='USDC', chain='Ethereum', project='aave-v3', 
                        apy=5.0, tvl=1000000, pool_meta=None):
...
class RecordValidator:
    ...
    @staticmethod
    def validate_extended_fields(record, apy_base=0, apy_reward=0, apy_mean_30d=0, 
                                apy_change_1d=0, apy_change_7d=0, apy_change_30d=0):
