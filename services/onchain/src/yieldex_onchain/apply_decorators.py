...
from src.onchain.protocol_decorators import track_withdraw, track_supply, sync_transaction_pool_balances
...
def apply_decorators():
    ...
    CompoundOperator.withdraw = track_withdraw('compound-v3')(original_compound_withdraw)
    ...
    from src.onchain.onchain_operator import execute_silo_market_transfer, execute_uniswap_flow
    
    # Apply sync decorator to complex flow methods
    execute_silo_market_transfer = sync_transaction_pool_balances(execute_silo_market_transfer)
